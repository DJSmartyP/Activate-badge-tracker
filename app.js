...
if('serviceWorker' in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('sw.js?v=1419',{updateViaCache:'none'}).catch(console.error));
init();
installBackGuard();
