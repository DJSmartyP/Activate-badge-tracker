const CACHE='activate-badges-v6-neon';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./favicon-64.png','./splash-portrait.png','./splash-landscape.png'];
